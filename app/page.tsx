...
const WhatsAppIcon = ({ size = 24, className, ...props }: { size?: number | string; className?: string }) => (
  <svg
    ...
    {...props}
  >
    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.232-.298.347-.497.115-.198.058-.372-.029-.548-.087-.174-.792-1.908-1.085-2.612-.285-.685-.574-.592-.792-.603-.205-.011-.44-.011-.673-.011-.233 0-.612.087-.932.434-.32.347-1.226 1.198-1.226 2.922 0 1.724 1.254 3.391 1.428 3.639.174.248 2.467 3.768 5.977 5.284 2.375 1.025 2.857.821 3.385.77.834-.08 1.758-.718 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" />
  </svg>
)
            ...
            <div className="space-y-20">
              ...
              <div className="grid grid-cols-1 gap-6 sm:gap-8 md:gap-10 lg:gap-12">
                {[
                  ...
                  const content = (
                    <div className="flex items-start sm:items-center gap-4 sm:gap-6 md:gap-8 lg:gap-10 group cursor-pointer">
                  ...
                  return item.href ? (
                    <a key={idx} href={item.href} target="_blank" rel="noopener noreferrer" className="block">
                      {content}
                    </a>
                  ) : (
                    <div key={idx}>
